...
- 🚀 I specialize in Python Django, RestAPI development, and Cyber Security, with a strong focus on the following technologies:

- Django, Django Rest, Celery for task management, Redis for caching and queuing, PostgreSQL for database management

- 📝 You can find my articles and in-depth technical insights at my [website](https://www.linkedin.com/in/berkay-şen/)

- 🔗 Let's connect on [LinkedIn](https://www.linkedin.com/in/berkay-şen/) to stay updated on my professional journey.

- 📧 Feel free to reach out to me via email at brktrl@protonmail.ch.

- 🔍 Explore my extensive experience and projects on [GitHub](https://github.com/Brktrlw).

- 💬 Don't hesitate to ask me about **Python, Django, Rest Framework,Redis, Celery, PostgreSQL, HTML, CSS, Javascript or anything related to Cyber Security, Kali Linux, or Pentesting. I'm here to share my knowledge and insights with you.
        </th>
    </tr>
</table>
<br>
